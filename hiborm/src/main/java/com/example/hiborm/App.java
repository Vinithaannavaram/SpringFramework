...
public class App 
{
    public static void main( String[] args )
    {
    	// to obtain/get the session from sessionfactory (It can be multiple session based on multiple services or work)
    		  ...
    		  Employee emp = new Employee("abc" , "abc@gmail.com"); // transient
...
//            tx = session.beginTransaction();
//            
//            Employee emp1 = new Employee("Rakshi" , "Rakshi@gmail.com"); // transient
// 		   
...
//// create two seperate files for native sql and for HQL (TO perform all the crud operations)
